...
trex=createSprite (100,200,40,70);
trex.addAnimation("t",trex1);
trex.addAnimation("c",trexCollider);
trex.scale= 0.5;
//trex.debug=true;
ground2= createSprite(200,356,400,10);
...
if(keyDown(UP_ARROW) && trex.y>310){
trex.velocityY = -10;
Jump.play();
}
score= score+1;
...
var R = Math.round(random(50,200));
cloud=createSprite(420,R);
...
var obstacle1 = createSprite(400,330);
